                 ...
                 <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-white dark:bg-zinc-800 px-2 text-stone-400 font-bold tracking-widest">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        disabled={isLoading}
                        className="w-full bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 text-stone-700 dark:text-zinc-200 py-3 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-stone-50 dark:hover:bg-zinc-800 transition-all shadow-sm active:scale-95 disabled:opacity-50"
                    >
